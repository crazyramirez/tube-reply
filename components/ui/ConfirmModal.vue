...
<template>
  ...
  >
    <div class="relative overflow-hidden bg-slate-900/90 backdrop-blur-2xl border border-white/10 rounded-2xl shadow-2xl">
      ...
      <div class="absolute -top-24 -right-24 w-48 h-48 bg-emerald-600/10 blur-[80px] rounded-full pointer-events-none" v-if="type === 'success'" />
      ...
      <div class="p-8 relative z-10">
        ...
        <div class="flex flex-col items-center text-center space-y-4">
          ...
          >
            <UIcon 
              :name="
                type === 'danger' ? 'i-heroicons-exclamation-triangle' : 
                type === 'success' ? 'i-heroicons-check-circle' :
        ...
        <div class="grid grid-cols-2 gap-4 mt-10">
          ...
          <button
            ...
            :class="[
              type === 'danger' ? 'bg-red-600 hover:bg-red-500 text-white shadow-red-900/20' : 
              type === 'success' ? 'bg-emerald-600 hover:bg-emerald-500 text-white shadow-emerald-900/20' :
